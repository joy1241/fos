    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - Devilian&Joy Food Empire system <a href="https://www.instagram.com/bestfriend_1241/?hl=en" target="_blank">bestfriend_1241</a></div></div>
        </footer>
